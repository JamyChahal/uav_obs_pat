...
#pragma clang diagnostic pop
    ...
    void spin_10Hz()
    {
      ...
      pose_data.header.stamp = ros_time;
      pose_data.pose.position.x = pose.Pos().X();
      pose_data.pose.position.y = pose.Pos().Y();
      pose_data.pose.position.z = pose.Pos().Z();
      pose_data.pose.orientation.x = pose.Rot().X();
      pose_data.pose.orientation.y = pose.Rot().Y();
      pose_data.pose.orientation.z = pose.Rot().Z();
      pose_data.pose.orientation.w = pose.Rot().W();
