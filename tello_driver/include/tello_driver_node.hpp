...
namespace tello_driver
{
  ...
  public:
    ...
    // Para
    std::string drone_ip_arg_;
    unsigned int rasp_port_arg_, cmd_port_arg_, state_port_arg_, video_port_arg_;
  ...
  public:
    ...
    TelloSocket(TelloDriverNode *driver, std::string drone_ip, unsigned short port):
      driver_(driver), socket_(io_service_, udp::endpoint(asio::ip::udp::v4(), port))
    {}
  ...
  public:
    ...
    StateSocket(TelloDriverNode *driver, std::string drone_ip, unsigned short data_port);
  ...
  public:
    ...
    VideoSocket(TelloDriverNode *driver, std::string drone_ip, unsigned short video_port, const std::string &camera_info_path);
